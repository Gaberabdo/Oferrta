...
///add
  void addCoupons({
    ...
    FirebaseFirestore.instance.collection('Coupons').add(model.toMap())
        .then((docRef) {
      var id = docRef.id;
      model.id = id;

      FirebaseFirestore.instance.collection('Coupons').doc(id).set(model.toMap())
          .then((_) {
...
snapshot.docs.forEach((element) {
  ...
  void updateCoupons({
    ...
    FirebaseFirestore.instance.collection('Coupons').doc(subscriptionId).update(model.toMap()).then((value) {
  ...
  void deleteCoupons(String subscriptionId) {
    FirebaseFirestore.instance.collection('Coupons').doc(subscriptionId).delete()
        .then((value) {
